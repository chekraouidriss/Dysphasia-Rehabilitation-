...
function Signup(){
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        axios.post('http://localhost:3002/Signup', {nom, prenom, email, password, phone, sexe, date})
        .then(result => {
            console.log(result)
            //navigate('/Login1')
        })
            ...
            <div className="col-lg-12">
                ...
                <div className="row justify-content-center">
                     ...
                     <div className="section-title">
                          ...
                          <p className="custom-title1"><g>Hey, Enter your details to create your account</g></p>
                     </div>
                    </div>
                </div>
                            ...
                            <div className="col-lg-5 col-md-4 col-12">
                                <div className="form-group">
                                    ...
                                    <div class="login-button">
                                        <Link to="/login1" type="button" className="btn">Login</Link>
                                    </div>
