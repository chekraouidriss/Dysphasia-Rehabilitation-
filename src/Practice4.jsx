...
import videoD from './assets/Respiration.mp4'
...
function Practice4(){
    ...
    const [exerciseNumber, setExerciseNumber] = useState(4);
    ...
    const handleMediaTypeChange = (type) => {
     ...
     const adjustVideoSize = () => {
        ...
        const videoRefretry = useRef(null);
            ...
            useEffect(() => {
                const exerciseNumber = 4; // Numéro de l'exercice pour cette page
...
<div className="obsvd">Exercice: Respiration</div>
<div className="obsvd1">Pratiquez la respiration profonde et régulière pour favoriser la relaxation</div>
<div className="obsvdd">et améliorer votre capacité respiratoire."</div>
<div className="obsvd3">En cas de difficultés respiratoires persistantes,expliquer ceci au spécialiste</div>
<div className="obsvd4">de la santé par un video ou audio.</div>
<div className="obsvd5">Si tout se passe bien lors de l'exercice de respiration, enregistrez également</div>
<div className="obsvd6">une explication en audio ou en vidéo pour partager vos observations.</div>
...
<div className="div3">
    ...
    <div className="exercices4">
        <img src={four} alt="" style={{ backgroundColor: 'white' , borderRadius: '50%'}} />
        <div className="textexercice"> Breathing_Exercice </div>
        <progress id="file" value="26" max="100"> 50% </progress>
        <div className="exercicelogo">
...
<div className="text2">
       Stop
       <div className="imagelogo4" onClick={handleStopClick}>
                        <img src={pause} alt="" />
                    </div>
    </div>
</div>
<Link to="/Practice5" style={{ textDecoration: 'none', color: 'inherit' }}>
    <div className="div6">
        <div className="text1">
            Next
