...
function Login1_specialiste(){
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        axios.post('http://localhost:3002/Login1_specialiste', {email, password})
        .then(result => {
            console.log(result)
           // Après la validation des identifiants spécialiste dans handleSubmit
            if (result.data.success) {
                 // Stocker l'ID et les données du spécialiste connecté dans le stockage local
                        localStorage.setItem('specialisteId', result.data.specialisteId);
                        localStorage.setItem('specialisteData', JSON.stringify(result.data.specialisteData));
                        navigate('/Home_specialiste');
                                    }
        })
                    ...
                    <div className="row justify-content-center">
                        <div className="custom-title-container">
                            <div className="section-title">
                                ...
                                <p className="custom-title7"><g>Hey Specialiste, Enter your email and password to login</g></p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="col-lg-5 col-md-4 col-12">
                                    <div className="form-group">
                                        ...
                                        <div class="login-button">
                                            <Link to="/signup_specialiste" type="button" className="btn">Sign Up</Link>
                                        </div>
                                        <div className="section-title">
...
export default Login1_specialiste