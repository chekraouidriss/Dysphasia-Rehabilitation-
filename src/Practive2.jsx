...
import videoD from './assets/slow_speech.mp4'
...
function Practice2(){
    ...
    const [exerciseNumber, setExerciseNumber] = useState(2);
    ...
    const handleMediaTypeChange = (type) => {
     ...
     const adjustVideoSize = () => {
        ...
        const videoRefretry = useRef(null);
            ...
            useEffect(() => {
                const exerciseNumber = 2; // Numéro de l'exercice pour cette page
...
<div className="obsvd">Exercice: Discours Lent</div>
<div className="obsvd1">La lune illumine la lande lugubre, éclairant les lézards luisants et les larges lézardes</div>
<div className="obsvd2">dans le sol. L'ombre des lames de l'épinard lentement se lance sur le lac léthargique. </div>
<div className="obsvd4">Les lucioles lumineuses luisent dans la nuit, laissant des traces lumineuses le long   </div>
<div className="obsvd5">des lacs limpides.</div>
...
<div className="div3">
    ...
    <div className="exercices2">
        <img src={two} alt="" style={{ backgroundColor: 'white' , borderRadius: '50%'}}/>
        <div className="textexercice"> Slow_Speech_Exercice </div>
        <progress id="file" value="18" max="100"> 50% </progress>
        <div className="exercicelogo">
...
<Link to="/Practice3" style={{ textDecoration: 'none', color: 'inherit' }}>
    <div className="div6">
        <div className="text1">
            Next
