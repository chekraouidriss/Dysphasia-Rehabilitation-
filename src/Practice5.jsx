...
import videoD from './assets/easy onset.mp4'
    ...
    const handleMediaTypeChange = (type) => {
     ...
     const adjustVideoSize = () => {
        ...
        const videoRefretry = useRef(null);
            ...
            useEffect(() => {
                const exerciseNumber = 5; // Numéro de l'exercice pour cette page
...
<div className="fleche"> <img src={fleche1} alt=""/></div> 
<div className="obsvd">Exercice: Début Facile</div>
<div className="obsvd1">1.Le chat noir dort tranquillement.</div>
<div className="obsvdfleche">1.Lllllllle chat noir dort tranquillement.</div>
<div className="obsvd3">2.L'océan s'étend à perte de vue, scintillant sous les rayons du soleil levant.</div>
<div className="obsvd5">3.La lune brillait dans le ciel nocturne, éclairant la campagne d'une lueur argentée.</div>
<div className="obsvd7">4.Dans le jardin luxuriant, les fleurs épanouies exhalaient un parfum enivrant.</div>
...
<div className="div3">
    ...
    <div className="exercices5">
        <img src={five} alt="" style={{ backgroundColor: 'white' , borderRadius: '50%'}}/>
        <div className="textexercice"> Easy_Onset_Exercice </div>
        <progress id="file" value="9" max="100"> 50% </progress>
        <div className="exercicelogo">
        <img src={easy} alt="" />
        </div>
    </div>
